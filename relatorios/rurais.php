...
$sql_count2 = "SELECT COUNT(zona) AS total2 FROM aluno WHERE zona = 'Rural' ORDER BY id_aluno ASC";

// SQL para selecionar os registros
$sql = "SELECT id_aluno, data, zona, comunidade FROM aluno WHERE zona = 'Rural' ORDER BY id_aluno ASC";
