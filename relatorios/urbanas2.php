...
$sql_count2 = "SELECT COUNT(zona) AS total2 FROM quest2 WHERE zona = 'Urbana' ORDER BY id_quest ASC";

// SQL para selecionar os registros
$sql = "SELECT id_quest, data, zona, bairro FROM quest2 WHERE zona = 'Urbana' ORDER BY id_quest ASC";
...
<html>
	...
	<h1>relatório parcial - Urbanas</h1>
