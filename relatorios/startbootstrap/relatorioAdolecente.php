	...
	<div class="heading">
		...
		<div class="container">			
            <div class = "form-row">
						...
						<h1><b>Atenção selecione os campos que vão compor o seu relatório!</b></h1>
						</div>
			<div class="agile-form">
				<form action="guardaRelatorioQuest1.php" method="post">
					<div class="form-row">
                ...
                <?php foreach(Relatorio::getColunasQuest2() as $coluna){ ?>
					<div class="form-group col-md-2">
						<label><?php echo $coluna['Field'] ?></label>
                        <input class="form-check-input" type="checkbox" name="campo[]" value="<?php echo $coluna['Field'] ?>">
                    </div>
				<?php }?>
